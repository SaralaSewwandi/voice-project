...
def mainCall(taskType, input_files, input_model):
    if taskType == 'enroll':
        return task_enroll(input_files, input_model)
    elif taskType == 'predict':
        return task_predict(input_files, input_model)
